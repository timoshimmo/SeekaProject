...
/**
 * Created by tokmang on 7/30/2016.
 */
public class DataHelper {
    ...
    private static List<ColorSuggestion> sColorSuggestions =
            new ArrayList<>(Arrays.asList(
                    new ColorSuggestion("business"),
                    new ColorSuggestion("Computer science"),
                    new ColorSuggestion("Management"),
                    new ColorSuggestion("Information technology"),
                    new ColorSuggestion("Psychology"),
                    new ColorSuggestion("Medicine")));
    ...
    public void findColors(Context context, String query, final OnFindColorsListener listener) {
