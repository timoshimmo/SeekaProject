...
/**
 * Created by tokmang on 8/19/2016.
 */
public class EduSysAdapter extends BaseAdapter {
    ...
    public EduSysAdapter(Context ctx, ArrayList<HashMap<String, ArrayList<String>>> ctry) {
        this.context = ctx;
        this.ctryNames = ctry;
