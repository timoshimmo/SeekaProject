 ...
 */
public class CareerExpListAdapter extends BaseExpandableListAdapter {
    ...
    public CareerExpListAdapter(Context context, List<String> expandableListTitle,
    ...
    public JSONArray setJsonCareerData() {
        return objArray;
    }
}
